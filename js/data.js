export const SKILLS_DB = [
    ...
    { id: 's04', name: '痛苦诅咒', reqLv: 5, type: 'dot', cd: 10000, cost: 10, dmgMult: 0.5, effects:[{type:'dot', dur:12000, dps:0.8}], priority: 8, desc:'[DoT] 立即造成{dmgMult}%攻击力伤害（约{dmg}），后续每秒造成{dps}%攻击力伤害，持续{dur}秒，消耗{cost}法力，冷却{cd}秒。' },
    ...
    { id: 's10', name: '月火术', reqLv: 22, type: 'dot', cd: 5000, cost: 8, dmgMult: 1.0, effects:[{type:'dot', dur:10000, dps:1.0}], priority: 8, desc:'[DoT] 立即造成{dmgMult}%攻击力伤害（约{dmg}），后续每秒造成{dps}%攻击力伤害，持续{dur}秒，消耗{cost}法力，冷却{cd}秒。' },
    ...
    { id: 's21', name: '星落', reqLv: 45, type: 'dot', cd: 20000, cost: 35, dmgMult: 2.0, effects:[{type:'dot', dur:8000, dps:2.5}], priority: 9, desc:'[DoT] 立即造成{dmgMult}%攻击力伤害（约{dmg}），后续每秒造成{dps}%攻击力伤害，持续{dur}秒，消耗{cost}法力，冷却{cd}秒。' },
    ...
    { id: 's29', name: '腐蚀之种', reqLv: 68, type: 'dot', cd: 15000, cost: 20, dmgMult: 1.5, effects:[{type:'dot', dur:15000, dps:1.5}], priority: 8, desc:'[DoT] 立即造成{dmgMult}%攻击力伤害（约{dmg}），后续每秒造成{dps}%攻击力伤害，持续{dur}秒，消耗{cost}法力，冷却{cd}秒。' },
    ...
    { id: 's33', name: '星光虹吸', reqLv: 76, type: 'dot', cd: 12000, cost: 15, dmgMult: 0.5, effects:[{type:'dot', dur:10000, dps:1.0}], priority: 9, desc:'[DoT] 立即造成{dmgMult}%攻击力伤害（约{dmg}），后续每秒造成{dps}%攻击力伤害，持续{dur}秒，消耗{cost}法力，冷却{cd}秒。' },
